...
ADD "https://github.com/AdoptOpenJDK/openjdk11-binaries/releases/download/jdk-11.0.10+9/OpenJDK11U-jdk_x64_linux_hotspot_11.0.10_9.tar.gz" jdk.tar.gz
RUN tar xzf jdk.tar.gz
RUN mv -f ./jdk-*/ /opt/java
